...
const Login = () => {
    ...
    return (
        <div className="">
            ...
            <form onSubmit={(e)=>e.preventDefault()} action="" method="get" className='flex flex-col items-center justify-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border-8 border-double border-gray-400 hover:border-gray-600  bg-black bg-opacity-70 p-10'>
